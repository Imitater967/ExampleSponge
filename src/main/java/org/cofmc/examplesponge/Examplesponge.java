package org.cofmc.examplesponge;
...
public class Examplesponge {
    ...
    @Inject
    Examplesponge(final PluginContainer container, final Logger logger) {
    ...
    public void onConstructPlugin(final ConstructPluginEvent event) {
        ...
        this.logger.info("Constructing examplesponge");
    }
    ...
    public void onRegisterCommands(final RegisterCommandEvent<Command.Parameterized> event) {
        ...
        event.register(this.container, Command.builder().addParameter(nameParam).permission("examplesponge.command.greet").executor(ctx -> {
